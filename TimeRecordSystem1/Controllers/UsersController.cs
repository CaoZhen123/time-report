...
namespace TimeRecordSystem1.Controllers
{
    public class UsersController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Register([Bind(Include = "Id,UserName,Password,FirstName,LastName,Email")] User user)
        {
            if (ModelState.IsValid)
            {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,UserName,Password,FirstName,LastName,Email")] User user)
        {
            if (ModelState.IsValid)
            {
